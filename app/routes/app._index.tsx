...
function truncate(text: string | undefined, length = 25) {
  if (!text) return "";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  console.log('first check these codes', qrCodes)
  return {qrCodes};
};
...
export default function Index() {
  ...
  console.log('index page loader data', qrCodes);

   return (
    <s-page heading="QR codes" inlineSize="large">
